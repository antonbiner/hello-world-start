...
import { loadSidebarConfig, seedSidebarDefaultsIfEmpty, resetSidebarConfig, ensureHrDropdownItems } from '../services/sidebar.service';
...
export function AppSidebar() {
  ...
  // Ensure HR dropdown has reports and departments (non-destructive)
  useEffect(() => {
    ...
    try {
      ...
      const hrDefault: SidebarItemConfig = {
        ...
        dropdown: [
          ...
          { title: 'reports', url: '/dashboard/hr/attendance/reports', description: 'Attendance reports' },
