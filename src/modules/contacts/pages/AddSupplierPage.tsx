  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        lastName: subType === 'individual' ? formData.lastName : formData.firstName,
        name: subType === 'individual' 
          ? `${formData.firstName} ${formData.lastName}`.trim() 
          : formData.firstName.trim(),
        email: formData.email || null,
        phone: formData.phone || null,
        company: subType === 'company' ? formData.firstName : null,
        position: subType === 'individual' ? (formData.position || null) : null,
