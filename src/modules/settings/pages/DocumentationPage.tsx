      ...
      modules: {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Quote and proposal management with status workflow (Created → Sent → Accepted/Declined/Expired), line item editing, PDF generation, email sending, validity date tracking, and automatic conversion to sales.",
      ...
      stages: [
        {
          ...
          details: [
            ...
            "Status workflow: Created → Sent → Accepted/Declined/Expired"
          ],
                    ...
                    <div className="grid gap-2">
                      {content.errorHandling.httpStatusCodes.codes.map((code, index) => (
                        <div key={index} className="flex items-start gap-3 p-3 rounded-lg bg-muted/50 hover:bg-muted transition-colors">
                          <Badge
                            variant="outline"
                            className={`shrink-0 w-14 justify-center ${code.code >= 500 ? 'bg-destructive/10 text-destructive' :
